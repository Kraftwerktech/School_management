...
function LayoutLesson() {
  ...
  const tabs = [
    { name: 'Approved Lesson', path: '/coordinator/dasboard/coapprovedLesson' },
    { name: 'Pending Lesson Plan', path: '/coordinator/dasboard/copendingLesson' },
  ];
      ...
      <nav className="flex gap-16 mt-10 border-b-[1px]">
        {tabs.map((tab) => (
          <NavLink
            ...
            to={tab.path}
            className={({ isActive }) =>
              (isActive || (tab.name === 'Approved Lesson' && location.pathname === '/coordinator/dasboard'))
