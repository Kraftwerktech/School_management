...
const TeacherFullInfo = () => {
  return (
    <div className='w-full mt-4'>
        <div className=' font-semibold flex gap-3 items-center text-[31px]'>
            <Link to="/teacher/dashboard/teacher-info"> <span><BsArrowLeftCircle className='w-7 h-7 text-[#BB5042]'/></span></Link>
           
            <span>Teacher Directory</span>
            </div>
            
    <div className=" w-full mr-[47px] mt-5  flex items-center justify-center">
      <div className=" w-full h-[566px] pt-2 bg-white rounded-lg  flex flex-col md:flex-row gap-6">
        ...
        {/* Profile Information */}
        <div className="flex-1 grid mr-[47px] grid-cols-1 md:grid-cols-2 border-[1px] p-8 gap-4 rounded-[8px] mb-5">
          ...
          <div className=' border-b-[1px] p-2 gap-1'>
            <h3 className="text-gray-600 font-medium flex gap-2">
            <span ><PiDeskLight className='h-6 w-6 text-[#BB5042]'/></span>
            <span className=' text-[16px]'>Room Number</span>
              </h3>
            <p className="text-[#939393] text-[16px] mt-3">2002</p>
          </div>
          <div className=' border-b-[1px] p-2 gap-1'>
            <h3 className="text-gray-600 font-medium flex gap-2">
    ...
    <div className='mt-10 mb-14 mr-[47px]'>
        <div className=' mt-5 mb-5'>
        <span className=' text-[#465049] font-semibold text-[20px]'>Working Experience</span>
        </div>
    
     <div>
     <div className="flex-1 grid grid-cols-1 md:grid-cols-2 border-[1px] p-8 gap-4 rounded-[8px] mb-5">
          <div className=' border-b-[1px] pb-3 gap-1'>
            <h3 className="text-gray-600 font-medium flex gap-2">
            <span><BiSolidInstitution className='h-6 w-6 text-[#BB5042]'/></span>
            <span className=' text-[16px]'>Institutions Name</span>
          ...
          <div className=' border-b-[1px]'>
            <h3 className="text-gray-600 font-medium flex gap-2">
            <span><MdOutlinePersonOutline className='h-6 w-6 text-[#BB5042]'/></span>
          ...
          <div className='  gap-1'>
            <h3 className="text-gray-600 font-medium flex gap-2">
            <span ><FaIdCardAlt className='h-6 w-6 text-[#BB5042]'/></span>
            <span className=' text-[16px]'>service Length</span>
              </h3>
            <p className="text-[#939393] text-[16px] mt-3">2002</p>
          </div>
          <div className='   gap-1'>
            <h3 className="text-gray-600 font-medium flex gap-2">
            <span><IoLocationOutline className='h-6 w-6 text-[#BB5042]'/></span>
               <span className=' text-[16px]'> Address</span></h3>
            <span className="text-[#939393] text-[16px] mt-3">O+</span>
          </div>
        </div>
     </div>
...
export default TeacherFullInfo;
